...
import {
  ...
  readUTF8LineTo3cgartetbq4tk as readUTF8LineTo,
  Companion_getInstance2zbi981hww1p4 as Companion_getInstance_0,
...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.p2q_1 = coroutineContext;
    this.q2q_1 = null;
    this.r2q_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  ou() {
    return this.p2q_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.t2q_1 = 0;
    this.u2q_1 = 0;
    this.v2q_1 = get_HeadersDataPool().w1i();
  }
  a25(name) {
    if (this.t2q_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.u2q_1 | 0;
    while (!(this.v2q_1.a2r(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.c2r(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.u2q_1 | 0;
    }
    return null;
  }
  d2r() {
    return this.v2q_1.z2q();
  }
  b2r(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.s2q_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.s2q_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.u2q_1 | 0;
    ...
    this.v2q_1.l2r(headerOffset + 0 | 0, hash);
    this.v2q_1.l2r(headerOffset + 1 | 0, nameStartIndex);
    this.v2q_1.l2r(headerOffset + 2 | 0, nameEndIndex);
    this.v2q_1.l2r(headerOffset + 3 | 0, valueStartIndex);
    this.v2q_1.l2r(headerOffset + 4 | 0, valueEndIndex);
    this.v2q_1.l2r(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.v2q_1.l2r(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.t2q_1 = this.t2q_1 + 1 | 0;
  }
  m2r(headerOffset) {
    var nameStartIndex = this.v2q_1.a2r(headerOffset + 1 | 0);
    var nameEndIndex = this.v2q_1.a2r(headerOffset + 2 | 0);
    return this.s2q_1.c(nameStartIndex, nameEndIndex);
  }
  c2r(headerOffset) {
    var valueStartIndex = this.v2q_1.a2r(headerOffset + 3 | 0);
    var valueEndIndex = this.v2q_1.a2r(headerOffset + 4 | 0);
    return this.s2q_1.c(valueStartIndex, valueEndIndex);
  }
  j1c() {
    this.t2q_1 = 0;
    this.u2q_1 = 0;
    get_HeadersDataPool().x1i(this.v2q_1);
    this.v2q_1 = get_HeadersDataPool().w1i();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.w2q_1 = ArrayList.n1();
  }
  x2q() {
    return this.w2q_1.i1();
  }
  y2q(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.w2q_1.b1(get_IntArrayPool().w1i());
      }
       while (inductionVariable < subArraysCount);
  }
  a2r(index) {
    return this.w2q_1.j1(index / 768 | 0)[index % 768 | 0];
  }
  l2r(index, value) {
    this.w2q_1.j1(index / 768 | 0)[index % 768 | 0] = value;
  }
  z2q() {
    return sequence(HeadersData$headersStarts$slambda_0(this));
  }
  j1c() {
    var _iterator__ex2g4s = this.w2q_1.d1();
    while (_iterator__ex2g4s.e1()) {
      var array = _iterator__ex2g4s.f1();
      get_IntArrayPool().x1i(array);
    }
    this.w2q_1.p2();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  s2r(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).u1i.call(this, instance);
  }
  u1i(instance) {
    return this.s2r(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  u1i(instance) {
    return this.w2r(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  static d2s(message) {
    var $this = this.u3(message);
    captureStack($this, $this.c2s_1);
    return $this;
  }
}
...
class parseMultipart$slambda$slambda {
  constructor($firstBoundary, $countedInput) {
    this.n2s_1 = $firstBoundary;
    this.o2s_1 = $countedInput;
  }
  t2s($this$writer, $completion) {
    return suspendOrReturn(/*#__NOINLINE__*/_generator_invoke__zhh2q8_0.bind(VOID, this, $this$writer), $completion);
  }
  ic(p1, $completion) {
    return this.t2s(p1 instanceof WriterScope ? p1 : THROW_CCE(), $completion);
  }
}
class parseMultipart$slambda {
  constructor($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
    this.p2s_1 = $input;
    this.q2s_1 = $boundaryPrefixed;
    this.r2s_1 = $maxPartSize;
    this.s2s_1 = $totalLength;
  }
  u2s($this$produce, $completion) {
    return suspendOrReturn(/*#__NOINLINE__*/_generator_invoke__zhh2q8_1.bind(VOID, this, $this$produce), $completion);
  }
  ic(p1, $completion) {
    return this.u2s((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  }
}
class Node {
...
class Companion {
  e2s(from) {
    ...
    return this.z2s(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  z2s(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
      // Inline function 'kotlin.collections.maxByOrNull' call
      var iterator = from.d1();
      if (!iterator.e1()) {
        tmp$ret$0 = null;
        break $l$block_0;
      }
    ...
    if (tmp1_elvis_lhs == null) {
      throw NoSuchElementException.q('Unable to build char tree from an empty list');
    } else {
    ...
    if (tmp$ret$2)
      throw IllegalArgumentException.u('There should be no empty entries');
    var root = ArrayList.n1();
...
class SubSequenceImpl {
  ...
  a() {
    return this.c2t_1 - this.b2t_1 | 0;
  }
  b(index) {
    var withOffset = index + this.b2t_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.c2t_1 - this.b2t_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.u(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.e2t_1, this.b2t_1 + startIndex | 0, this.b2t_1 + endIndex | 0);
  }
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.e2t_1, this.b2t_1, this.c2t_1));
      this.d2t_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.e2t_1, this.b2t_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.d2t_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.e2t_1, this.b2t_1, this.c2t_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.k2r_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.k2r_1 + ')';
      throw IllegalArgumentException.u(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.k2r_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.k2r_1 + ')';
      throw IllegalArgumentException.u(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.k2r_1));
      this.h2r_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.k2r_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.k2r_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.h2r_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.k2r_1) : tmp1_elvis_lhs;
  }
  ma(value) {
    nonFullBuffer(this)[ensureNotNull(this.g2r_1).length - this.j2r_1 | 0] = value;
    this.h2r_1 = null;
    this.j2r_1 = this.j2r_1 - 1 | 0;
    this.k2r_1 = this.k2r_1 + 1 | 0;
    return this;
  }
  lf(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.j2r_1 | 0;
      ...
      this.j2r_1 = this.j2r_1 - bytesToCopy | 0;
    }
    this.h2r_1 = null;
    this.k2r_1 = this.k2r_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  c1(value) {
    if (value == null)
      return this;
    return this.lf(value, 0, charSequenceLength(value));
  }
  j1c() {
    var list = this.f2r_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.e2r_1.x1i(list.j1(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.g2r_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.e2r_1.x1i(tmp0_safe_receiver);
      }
      this.g2r_1 = null;
    }
    this.i2r_1 = true;
...
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.x2r_1 + ', end=' + this.y2r_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.t2q_1 >= $this.u2q_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.t2q_1;
  var prevData = $this.v2q_1;
  $this.t2q_1 = 0;
  $this.u2q_1 = imul($this.u2q_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().w1i();
  this_0.y2q(imul(prevData.x2q(), 2) | 1);
  tmp.v2q_1 = this_0;
  var _iterator__ex2g4s = prevData.z2q().d1();
  while (_iterator__ex2g4s.e1()) {
    var headerOffset = _iterator__ex2g4s.f1();
    $this.b2r(prevData.a2r(headerOffset + 1 | 0), prevData.a2r(headerOffset + 2 | 0), prevData.a2r(headerOffset + 3 | 0), prevData.a2r(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().x1i(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.t2q_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.v2q_1.a2r(headerOffset + 1 | 0);
  var nameEndIndex = $this.v2q_1.a2r(headerOffset + 2 | 0);
  return equalsLowerCase($this.s2q_1, nameStartIndex, nameEndIndex, name);
}
function *_generator_invoke__zhh2q8($this, $this$sequence, $completion) {
  var joinedIndex = 0;
  var _iterator__ex2g4s = $this.n2r_1.w2q_1.d1();
  while (_iterator__ex2g4s.e1()) {
    var arr = _iterator__ex2g4s.f1();
    var localIndex = 0;
    while (localIndex < arr.length) {
      if (!($this.n2r_1.a2r(joinedIndex + 0 | 0) === -1)) {
        var tmp = $this$sequence.xi(joinedIndex, $completion);
...
function HeadersData$headersStarts$slambda_0(this$0) {
  ...
  var l = ($this$sequence, $completion) => i.o2r($this$sequence, $completion);
  l.$arity = 1;
  return l;
}
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.d2r().d1();
  while (_iterator__ex2g4s.e1()) {
    var offset = _iterator__ex2g4s.f1();
    out.c1(indent);
    out.c1(_this__u8e3s4.m2r(offset));
    out.c1(' => ');
    out.c1(_this__u8e3s4.c2r(offset));
    out.c1('\n');
  }
}
...
function *_generator_parseHeaders__yk88b9(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.y2r_1 = builder.k2r_1;
      var rangeLength = range.y2r_1 - range.x2r_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.x2r_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.y2r_1;
      parseHeaderValue(builder, range);
      var valueStart = range.x2r_1;
      var valueEnd = range.y2r_1;
      range.x2r_1 = headerEnd;
      headers.b2r(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.a25(HttpHeaders_getInstance().l2e_1);
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.x2r_1;
  var end = range.y2r_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.x2r_1)) {
      range.x2r_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.x2r_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.x2r_1 = valueStart;
  range.y2r_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.d2s("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$1;
  $l$block: {
  ...
  if (tmp$ret$1) {
    throw ParserException.d2s('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.d2s('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.d2s('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.x2r_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.y2r_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.d2s('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.d2s('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().z1g_1, Companion_getInstance_0().y1g_1);
    versions = Companion_instance.e2s(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().d2c(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.m2s('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.iq(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.yt("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.yt('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.yt('Empty multipart boundary is not allowed');
  }
...
function *_generator_parsePartHeadersImpl__ngvtk8(input, $completion) {
  ...
  try {
    ...
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.uq('Failed to parse multipart headers: unexpected end of stream');
    } else {
...
function *_generator_parsePartBodyImpl__8tyvmc(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.a25('Content-Length');
  ...
  if (contentLength == null) {
    ...
    if (compare(new Long(0, 0), contentLength) <= 0 ? compare(contentLength, limit) <= 0 : false) {
  ...
  var byteCount = tmp;
  var tmp_3 = output.m1f($completion);
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.yt('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.yt("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function *_generator_invoke__zhh2q8_0($this, $this$writer, $completion) {
  var tmp = parsePreambleImpl($this.n2s_1, $this.o2s_1, $this$writer.j1h_1, new Long(8193, 0), $completion);
  if (tmp === get_COROUTINE_SUSPENDED())
    tmp = yield tmp;
  var tmp_0 = $this$writer.j1h_1.i1g($completion);
  if (tmp_0 === get_COROUTINE_SUSPENDED())
    tmp_0 = yield tmp_0;
  return Unit_instance;
}
function *_generator_invoke__zhh2q8_1($this, $this$produce, $completion) {
  var countedInput = counted($this.p2s_1);
  var readBeforeParse = countedInput.z1h();
  var firstBoundary = $this.q2s_1.kq(get_PrefixString().i1());
  var tmp = readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda_0(firstBoundary, countedInput)).h1h_1, $completion);
  if (tmp === get_COROUTINE_SUSPENDED())
    tmp = yield tmp;
  var preambleData = tmp;
  if (compare(get_remaining(preambleData), new Long(0, 0)) > 0) {
    var tmp_0 = $this$produce.i18(new Preamble(preambleData), $completion);
    if (tmp_0 === get_COROUTINE_SUSPENDED())
      tmp_0 = yield tmp_0;
  }
  $l$loop_0: while (true) {
    ...
    var tmp_5 = $this$produce.i18(part, $completion);
    ...
    try {
      ...
      if (tmp_6 === get_COROUTINE_SUSPENDED())
        tmp_6 = yield tmp_6;
      headersMap = tmp_6;
      if (!headers.t10(headersMap)) {
        headersMap.j1c();
        throw CancellationException.cc('Multipart processing has been cancelled');
      }
      var tmp_7 = parsePartBodyImpl($this.q2s_1, countedInput, body, headersMap, $this.r2s_1, $completion);
  ...
  if (tmp_9 === get_COROUTINE_SUSPENDED())
    tmp_9 = yield tmp_9;
  if (!($this.s2s_1 == null)) {
    var consumedExceptEpilogue = subtract(countedInput.z1h(), readBeforeParse);
    var size = subtract($this.s2s_1, consumedExceptEpilogue);
    if (compare(size, new Long(2147483647, 0)) > 0)
      throw IOException.yt('Failed to parse multipart: prologue is too long');
    if (compare(size, new Long(0, 0)) > 0) {
      ...
      if (tmp_10 === get_COROUTINE_SUSPENDED())
        tmp_10 = yield tmp_10;
      var tmp_11 = $this$produce.i18(new Epilogue(tmp_10), $completion);
    ...
    if (!epilogueContent.wq()) {
      var tmp_13 = $this$produce.i18(new Epilogue(epilogueContent), $completion);
...
function parseMultipart$slambda$slambda_0($firstBoundary, $countedInput) {
  ...
  var l = ($this$writer, $completion) => i.t2s($this$writer, $completion);
  l.$arity = 1;
  return l;
}
function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  ...
  var l = ($this$produce, $completion) => i.u2s($this$produce, $completion);
  l.$arity = 1;
  return l;
}
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.iq(toByteArray_0('\r\n'));
...
function build($this, resultList, from, maxLength, idx, length, charAt) {
  ...
  var destination = LinkedHashMap.wa();
  var _iterator__ex2g4s = from.d1();
  while (_iterator__ex2g4s.e1()) {
    var element = _iterator__ex2g4s.f1();
  ...
  var _iterator__ex2g4s_0 = destination.q1().d1();
  while (_iterator__ex2g4s_0.e1()) {
    ...
    var nextIdx = idx + 1 | 0;
    var children = ArrayList.n1();
    var tmp_0 = Companion_instance;
    // Inline function 'kotlin.collections.filter' call
    // Inline function 'kotlin.collections.filterTo' call
    var destination_0 = ArrayList.n1();
    var _iterator__ex2g4s_1 = list_0.d1();
    ...
    var _iterator__ex2g4s_2 = list_0.d1();
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.g2r_1).length | 0];
}
function copy($this, startIndex, endIndex) {
  if (startIndex === endIndex)
    return '';
  var builder = StringBuilder.oa(endIndex - startIndex | 0);
  var buffer;
...
function bufferForIndex($this, index) {
  ...
  return list.j1(index / ensureNotNull($this.g2r_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.i2r_1)
    throw IllegalStateException.u3('Buffer is already released');
  throw IndexOutOfBoundsException.xc('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.j2r_1 === 0 ? appendNewArray($this) : ensureNotNull($this.g2r_1);
}
function appendNewArray($this) {
  var newBuffer = $this.e2r_1.w1i();
  var existing = $this.g2r_1;
  $this.g2r_1 = newBuffer;
  $this.j2r_1 = newBuffer.length;
  $this.i2r_1 = false;
  if (!(existing == null)) {
    var tmp0_elvis_lhs = $this.f2r_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = ArrayList.n1();
      $this.f2r_1 = this_0;
      this_0.b1(existing);
      tmp = this_0;
    } else {
...
function currentPosition($this) {
  return ensureNotNull($this.g2r_1).length - $this.j2r_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.dd('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.dd('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.l2i_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.l2i_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().k2i_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.z2s(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
    ...
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList.l1(collectionSizeOrDefault(this_9, 10));
